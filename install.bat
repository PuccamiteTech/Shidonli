...
wget https://downloads.bitnami.com/files/stacks/wampstack/8.1.8-0/bitnami-wampstack-8.1.8-0-windows-x64-installer.exe
...
pause
bitnami-wampstack-8.1.8-0-windows-x64-installer.exe
del /Q C:\Bitnami\wampstack-8.1.8-0\apache2\htdocs\*.*
del /Q C:\Bitnami\wampstack-8.1.8-0\apache2\htdocs\img\*.*
copy htdocs.zip C:\Bitnami\wampstack-8.1.8-0\apache2\
cls
